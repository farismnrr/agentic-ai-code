...
const dialogTitle = computed(() => props.server ? `Manage ${props.server.name}` : 'Add remote MCP')
...
<template>
  <UModal
    v-model:open="open"
    :title="dialogTitle"
    description="Configure and verify the remote connection before AI Code uses its tools."
