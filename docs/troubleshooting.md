...
## Public MCP `/health` works but ChatGPT cannot connect
...
8. the current ChatGPT callback URI is allowlisted exactly.
...
before debugging ChatGPT UI behavior.

## ChatGPT connects but shows an old tool catalog
