...
external MCP client controls how progress/tool cards are rendered. The relay can provide protocol state and results, but it cannot force external MCP client to render raw terminal output like a native terminal UI.
