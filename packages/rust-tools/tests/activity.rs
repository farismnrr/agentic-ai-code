use ai_tools::application::activity::{
    complete_event, event_for_tool, ActivityEvent, ActivityRecorder, Category, Effect, Evidence,
    Presentation, Status,
};
use ai_tools::core::config::{ActivityMode, ServerConfig};
use ai_tools::infrastructure::activity::{ActivityRuntime, ReloadableActivityRecorder};
...
fn event(activity_id: &str) -> ActivityEvent {
    ActivityEvent {
        ...
        actor: ai_tools::application::activity::actor_or_external(None),
        client_info: None,
        occurred_at_ms: 1,
        ingested_at_ms: None,
        duration_ms: None,
