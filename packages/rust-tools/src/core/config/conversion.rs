...
impl From<&Cli> for ServerConfig {
    fn from(cli: &Cli) -> Self {
        Self {
            ...
            creative_max_job_output_bytes: cli.creative_max_job_output_bytes,
            creative_max_concurrent_jobs: cli.creative_max_concurrent_jobs,
            creative_max_retries: cli.creative_max_retries,
