...
pub(in crate::application::git) struct ChangeRequestSummary {
    number: u64,
    title: String,
    url: String,
    state: String,
...
pub(in crate::application::git) struct ChangeRequestListResult {
...
#[derive(Debug, Serialize)]
pub(in crate::application::git) struct ChangeRequestResult {
    repository_root: String,
    forge: ForgeRepository,
...
#[derive(Debug, Clone, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct CheckSummary {
    bucket: String,
    name: String,
    state: String,
    workflow: String,
...
#[derive(Debug, Serialize)]
pub(in crate::application::git) struct ChangeRequestChecksResult {
    repository_root: String,
    forge: ForgeRepository,
    number: u64,
...
pub(in crate::application::git) async fn change_request_list(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn change_request_get(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn change_request_create(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<ChangeRequestResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
...
pub(in crate::application::git) async fn change_request_update(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<ChangeRequestResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
...
pub(in crate::application::git) async fn change_request_checks(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn change_request_merge(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<ChangeRequestResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
