...
pub(in crate::application::git) use model::*;
use validation::*;
...
pub(in crate::application::git) async fn issue_list(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn issue_get(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn issue_create(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<IssueResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
...
pub(in crate::application::git) async fn issue_update(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<IssueResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
...
pub(in crate::application::git) async fn issue_comment(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn issue_close(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<IssueResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
...
pub(in crate::application::git) async fn issue_reopen(
    arguments: &Value,
    config: &ServerConfig,
) -> Result<IssueResult, McpError> {
    let repo = resolve_repo(arguments, config)?;
