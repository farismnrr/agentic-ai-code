...
pub(in crate::application::git) const MAX_TITLE_BYTES: usize = 256;
pub(in crate::application::git) const MAX_BODY_BYTES: usize = 64 * 1024;
pub(in crate::application::git) const MAX_LABEL_NAME_BYTES: usize = 128;

#[derive(Debug, Clone, Serialize)]
pub(in crate::application::git) struct ForgeRepository {
    pub(in crate::application::git) provider: &'static str,
    pub(in crate::application::git) owner: String,
    pub(in crate::application::git) repository: String,
}

pub(in crate::application::git) fn forge_identity(
...
pub(in crate::application::git) fn repo_spec(remote: &remote::GitRemoteIdentity) -> String {
    format!("{}/{}", remote.owner, remote.repository)
}

pub(in crate::application::git) fn parse_json<T: serde::de::DeserializeOwned>(
    output: &[u8],
) -> Result<T, McpError> {
...
pub(in crate::application::git) fn bounded_text(
    arguments: &Value,
    key: &str,
    max: usize,
    allow_empty: bool,
...
pub(in crate::application::git) fn requested_number(
    arguments: &Value,
    entity_name: &str,
) -> Result<u64, McpError> {
    arguments
...
pub(in crate::application::git) fn parse_label_array(
    arguments: &Value,
    key: &str,
    max_count: usize,
