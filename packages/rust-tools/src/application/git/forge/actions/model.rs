...
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct WorkflowSummary {
    pub id: u64,
    pub name: String,
    pub path: String,
    pub state: String,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct WorkflowListResult {
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct WorkflowResult {
    pub repository_root: String,
    pub forge: ForgeRepository,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct RunSummary {
    pub id: u64,
    pub number: u64,
    pub attempt: u64,
    pub workflow_id: u64,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct RunListResult {
    pub repository_root: String,
    pub forge: ForgeRepository,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct RunResult {
    pub repository_root: String,
    pub forge: ForgeRepository,
    pub run: RunSummary,
}
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct StepSummary {
    pub number: u64,
    pub name: String,
    pub status: String,
    pub conclusion: String,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct JobSummary {
    pub id: u64,
    pub name: String,
    pub status: String,
    pub conclusion: String,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct RunJobsResult {
    pub repository_root: String,
    pub forge: ForgeRepository,
    pub run_id: u64,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(in crate::application::git) struct JobLogPreviewResult {
    pub repository_root: String,
    pub forge: ForgeRepository,
    pub job_id: u64,
