...
pub(in crate::application::git) async fn workflow_list(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn workflow_get(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn workflow_run_list(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn workflow_run_get(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn workflow_run_jobs(
    arguments: &Value,
    config: &ServerConfig,
...
pub(in crate::application::git) async fn workflow_job_log_preview(
    arguments: &Value,
    config: &ServerConfig,
