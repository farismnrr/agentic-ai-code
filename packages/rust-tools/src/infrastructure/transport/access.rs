...
use crate::infrastructure::observability::safe_log_field;
use crate::infrastructure::security::enforce_local_access_policy;
use crate::interfaces::mcp::ErrorResponse;
...
pub(super) async fn access_policy(
    ...
    if let crate::core::config::SecurityMode::Remote = state.config.mode {
        ...
        let is_https = crate::infrastructure::security::trusted_proxy_https(
            peer,
            forwarded_proto,
