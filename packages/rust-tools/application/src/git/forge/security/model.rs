...
pub(in crate::git) struct SecurityListResult<T> {
...
#[derive(Debug, Serialize)]
pub(in crate::git) struct SecurityGetResult<T> {
    pub(super) repository_root: String,
    pub(super) forge: ForgeRepository,
    pub(super) alert: T,
}
#[derive(Debug, Serialize)]
pub(in crate::git) struct SecretLocationsResult {
    pub(super) repository_root: String,
    pub(super) forge: ForgeRepository,
...
#[derive(Debug, Serialize)]
pub(in crate::git) struct DependabotAlert {
...
#[derive(Debug, Serialize)]
pub(in crate::git) struct CodeAlert {
    pub(super) number: u64,
    pub(super) state: String,
...
#[derive(Debug, Serialize)]
pub(in crate::git) struct CodeLocation {
...
#[derive(Debug, Serialize)]
pub(in crate::git) struct SecretAlert {
    pub(super) number: u64,
    pub(super) state: String,
...
#[derive(Debug, Serialize)]
pub(in crate::git) struct SecretLocation {
