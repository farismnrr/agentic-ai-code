...
pub struct Cli {
    ...
    /// MCP tool exposure profile. Full is the canonical superset; Primary is the external MCP client fast-path subset and may include capability-filtered delegation.
