...
Use this content in ChatGPT Custom Instructions. The workspace-isolation rules are intentionally global because they must apply before a project-local skill can be selected.
...
ChatGPT Memory may help recall project names or preferences, but it is never filesystem authority.
