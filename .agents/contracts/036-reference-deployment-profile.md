...
8. connect external MCP client in developer mode, complete OAuth, inspect tools, then test a safe tool call before terminal execution;
...
- external MCP client OAuth completion;
- external MCP client tool invocation.
