...
Decisions already made: full scope including settings, all four MCP surfaces, and its own visual identity using Nuxt UI's semantic tokens (no external MCP client pixel-chasing).
