...
2. first-party Nuxt MCP, paired/local-terminal calls, direct ChatGPT remote MCP, generic MCP clients, task/job execution, and relevant delegated/background execution all use the same activity contract;
