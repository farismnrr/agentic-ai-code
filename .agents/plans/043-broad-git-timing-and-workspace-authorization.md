...
- TypeScript source support is verified when the language server is explicitly configured. Operator relay is restarted and live; external MCP client action rediscovery is ready.
