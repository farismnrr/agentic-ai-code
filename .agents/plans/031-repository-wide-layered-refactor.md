...
- `cargo audit`;
- existing deterministic relay/MCP/security acceptance scripts applicable to the touched boundaries, including black-box, external MCP client contract, and zero-bypass checks;
