...
7. the final MCP contract is versioned and deterministic, the operator relay is rebuilt/restarted from the reviewed merged commit, and ChatGPT connector rediscovery proves the new tools live.
...
- [ ] ChatGPT connector rediscovery proof
...
- [ ] ChatGPT connector rediscovery exposes the new tool surface.
