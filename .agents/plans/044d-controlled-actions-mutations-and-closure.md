...
Add only the three GitHub Actions mutations needed for practical engineering control, then perform the composed Plan-044 security review, contract versioning, integration, release build, relay restart, live MCP verification, and ChatGPT connector rediscovery required to close the entire Plan 044 family.
...
## PHASE-08 — ChatGPT connector rediscovery and documentation closure
...
**Outcome:** ChatGPT sees and can invoke the new Plan-044 surface.
...
- Modify: `packages/rust-tools/README.md`, `docs/chatgpt.md`, and other directly affected operator docs.
...
- [ ] ChatGPT connector rediscovery exposes Plan-044 tools.
