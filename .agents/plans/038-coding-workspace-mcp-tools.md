...
**Evidence:** `scripts/verify-workspace-docs.sh` checks the 12-tool inventory and Workspace v1 defaults against the frozen runtime `tools/list` contract; `scripts/phase7-chatgpt-contract.sh` verifies that frozen catalog against a freshly built relay.
