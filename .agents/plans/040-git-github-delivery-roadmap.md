...
- [x] composed release deploy + ChatGPT resync + live GitHub/MCP acceptance + operator-approved final adversarial closure review
...
- deployed relay served the refreshed MCP catalog after ChatGPT resync;
