...
- [Plan 029 — native MCP integration](029-chatgpt-native-mcp-integration.md)
- [Plan 029b — remaining production/live-acceptance hardening](029b-chatgpt-mcp-production-hardening.md)
...
Plan 028 itself is complete. Remaining live-client/production acceptance work is tracked separately in [Plan 029b](029b-chatgpt-mcp-production-hardening.md); do not reopen this historical rewrite plan for that work.
