...
No deployed relay URL, external MCP client workspace, OAuth tenant, or callback credentials were available. Therefore Scan Tools, OAuth registration/PKCE/refresh/OIDC, live coding E2E, and live negative-boundary evidence are explicitly unverified; this is an accepted release limitation and does not constitute fabricated evidence.
