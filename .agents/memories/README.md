...
- **Plan 035 — `035-end-to-end-observability-and-secure-telemetry.md` is CLOSED** after implementation branch `feat/035-p0-observability-contract`, final commit `2aabaad`. Durable final behavior:
