...
expect(has(activity, 'client_info') && has(activity, 'ClientInfo') && has(activity, 'actor: actor_or_external(None)') && !has(activity, 'external MCP client'), 'caller identity must be metadata-only and vendor-neutral')
