...
# ChatGPT/public-MCP acceptance harness. Static checks always run; live
# deployment evidence is opt-in because this repository cannot drive a user's
# ChatGPT workspace or provision the external tunnel/Authorization Server.
...
# This is intentionally not called "ChatGPT E2E pass". A successful metadata
# probe is necessary deployment evidence, but the actual ChatGPT OAuth + tool
# flow still has to be exercised from ChatGPT developer mode.
