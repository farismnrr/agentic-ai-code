...
test ! -e docs/external-mcp.md
test ! -e docs/keycloak.md
if rg -n -i 'external-mcp|openai|external-mcp|external-mcp|antigravity|gemini|cloudflare|keycloak|auth0|github|ghcr' docs --glob '*.md'; then
